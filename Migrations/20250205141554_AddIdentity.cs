        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MyUsername = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    RequestSourceID = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RequestSources", x => x.RequestSourceID);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_RequestDetails_RequestSources_RequestSourceID",
                        column: x => x.RequestSourceID,
                        principalTable: "RequestSources",
                        principalColumn: "RequestSourceID",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_RequestDetails_Suppliers_SupplierID",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EmailNotifications", x => x.EmailID);
                    table.ForeignKey(
                        name: "FK_EmailNotifications_RequestDetails_RequestDetailID",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_StockRequests_RequestDetails_RequestDetailID",
                        column: x => x.RequestDetailID,
                        principalTable: "RequestDetails",
                        principalColumn: "RequestDetailID",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_StockRequests_Stocks_StockID",
                        column: x => x.StockID,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EmailNotifications_RequestDetailID",
                table: "EmailNotifications",
                column: "RequestDetailID");

            migrationBuilder.CreateIndex(
                name: "IX_RequestDetails_RequestSourceID",
                table: "RequestDetails",
                column: "RequestSourceID");

            migrationBuilder.CreateIndex(
                name: "IX_RequestDetails_SupplierID",
                table: "RequestDetails",
                column: "SupplierID");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StockRequests_RequestDetailID",
                table: "StockRequests",
                column: "RequestDetailID");
